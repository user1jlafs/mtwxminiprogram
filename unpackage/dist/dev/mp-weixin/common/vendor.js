...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"milkteawxprogram","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 26 */
/*!*****************************************************!*\
  !*** D:/MilkTeaProject/milkteawxprogram/pages.json ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 33 */
/*!*********************************************************!*\
  !*** D:/MilkTeaProject/milkteawxprogram/store/index.js ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 35 */
/*!********************************************************!*\
  !*** D:/MilkTeaProject/milkteawxprogram/store/cart.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = {
  ...
  mutations: {
    ...
    addToCart: function addToCart(state, goods) {
      // 生成规格字符串用于比较
      var specsStr = goods.specs ? JSON.stringify(goods.specs) : '';

      // 查询购物车中是否已有该商品（相同ID和相同规格）
      var findResult = state.cart.find(function (item) {
        var itemSpecsStr = item.specs ? JSON.stringify(item.specs) : '';
        return item.id === goods.id && itemSpecsStr === specsStr;
      });
      if (!findResult) {
        // 如果购物车中没有这件商品（或相同商品但不同规格），则直接push
        // 默认新添加的商品是选中状态
        state.cart.push(_objectSpread(_objectSpread({}, goods), {}, {
          selected: true
        }));
      } else {
    ...
    // 更新购物车中商品的数量
    updateGoodsQuantity: function updateGoodsQuantity(state, goods) {
      // 根据id查询购物车中对应商品
      var findResult = state.cart.find(function (item) {
    ...
    // 更新商品的选中状态
    updateGoodsSelected: function updateGoodsSelected(state, _ref) {
      var id = _ref.id,
    ...
    // 更新所有商品的选中状态
    updateAllGoodsSelected: function updateAllGoodsSelected(state, selected) {
      // 循环更新所有商品的选中状态
    ...
    // 批量添加商品到购物车
    addMultiToCart: function addMultiToCart(state, goodsList) {
    ...
    // 批量删除选中的商品
    removeSelectedGoods: function removeSelectedGoods(state) {
      // 过滤掉选中的商品
      state.cart = state.cart.filter(function (item) {
  ...
  getters: {
    ...
    // 获取购物车中指定商品的数量
    getGoodsQuantity: function getGoodsQuantity(state) {
      return function (id) {
        var findResult = state.cart.find(function (item) {
          return item.id === id;
        });
    ...
    // 获取购物车中选中的商品列表
    selectedCartList: function selectedCartList(state) {
      return state.cart.filter(function (item) {
        return item.selected;
      });
    }
...
/* 36 */
/*!********************************************************!*\
  !*** D:/MilkTeaProject/milkteawxprogram/store/user.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = {
  ...
  mutations: {
    // 更新用户登录状态
    updateLoginState: function updateLoginState(state, token) {
      state.token = token;
...
/* 46 */
/*!*************************************************************!*\
  !*** D:/MilkTeaProject/milkteawxprogram/api/HomeRequest.js ***!
  \*************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
function GetHomeDataRequest() {
  return _request.default.get('/api/home');
}

/***/ }),
/* 47 */
/*!***********************************************************!*\
  !*** D:/MilkTeaProject/milkteawxprogram/utils/request.js ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = void 0;
var _luchRequest = _interopRequireDefault(__webpack_require__(/*! luch-request */ 48));
...
/* 48 */
/*!********************************************************************************************!*\
  !*** D:/MilkTeaProject/milkteawxprogram/node_modules/luch-request/src/lib/luch-request.js ***!
  \********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 49 */
/*!********************************************************************************************!*\
  !*** D:/MilkTeaProject/milkteawxprogram/node_modules/luch-request/src/lib/core/Request.js ***!
  \********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 50 */
/*!****************************************************************************************************!*\
  !*** D:/MilkTeaProject/milkteawxprogram/node_modules/luch-request/src/lib/core/dispatchRequest.js ***!
  \****************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 51 */
/*!**********************************************************************************************!*\
  !*** D:/MilkTeaProject/milkteawxprogram/node_modules/luch-request/src/lib/adapters/index.js ***!
  \**********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 52 */
/*!************************************************************************************************!*\
  !*** D:/MilkTeaProject/milkteawxprogram/node_modules/luch-request/src/lib/helpers/buildURL.js ***!
  \************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 53 */
/*!*************************************************************************************!*\
  !*** D:/MilkTeaProject/milkteawxprogram/node_modules/luch-request/src/lib/utils.js ***!
  \*************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 54 */
/*!**************************************************************************************************!*\
  !*** D:/MilkTeaProject/milkteawxprogram/node_modules/luch-request/src/lib/core/buildFullPath.js ***!
  \**************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 55 */
/*!*****************************************************************************************************!*\
  !*** D:/MilkTeaProject/milkteawxprogram/node_modules/luch-request/src/lib/helpers/isAbsoluteURL.js ***!
  \*****************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 56 */
/*!***************************************************************************************************!*\
  !*** D:/MilkTeaProject/milkteawxprogram/node_modules/luch-request/src/lib/helpers/combineURLs.js ***!
  \***************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 57 */
/*!*******************************************************************************************!*\
  !*** D:/MilkTeaProject/milkteawxprogram/node_modules/luch-request/src/lib/core/settle.js ***!
  \*******************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 58 */
/*!*******************************************************************************************************!*\
  !*** D:/MilkTeaProject/milkteawxprogram/node_modules/luch-request/src/lib/core/InterceptorManager.js ***!
  \*******************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 59 */
/*!************************************************************************************************!*\
  !*** D:/MilkTeaProject/milkteawxprogram/node_modules/luch-request/src/lib/core/mergeConfig.js ***!
  \************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 60 */
/*!*********************************************************************************************!*\
  !*** D:/MilkTeaProject/milkteawxprogram/node_modules/luch-request/src/lib/core/defaults.js ***!
  \*********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 61 */
/*!*******************************************************************************************!*\
  !*** D:/MilkTeaProject/milkteawxprogram/node_modules/luch-request/src/lib/utils/clone.js ***!
  \*******************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = clone;
exports.default = _default;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../../../../../../HBuilderX.4.36.2024112817/HBuilderX/plugins/uniapp-cli/node_modules/buffer/index.js */ 62).Buffer))
...
/* 74 */
/*!*****************************************************************!*\
  !*** D:/MilkTeaProject/milkteawxprogram/api/CategoryRequest.js ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 83 */
/*!**************************************************************!*\
  !*** D:/MilkTeaProject/milkteawxprogram/api/OrderRequest.js ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
function CreateOrderRequest(obj) {
  return _request.default.post('/api/orders', obj);
}
// 获取用户订单列表
...
function GetUserOrderDetailRequest(orderId) {
  return _request.default.get("/api/orders/".concat(orderId));
}
// 取消订单
function CancelOrderRequest(orderId) {
  return _request.default.put("/api/orders/".concat(orderId, "/cancel"));
}
// 支付订单
function PayOrderRequest(orderId) {
  return _request.default.put("/api/orders/".concat(orderId, "/pay"));
}
// 确认收货
...
exports.GetAllProductRequest = GetAllProductRequest;
exports.GetHotSearchRequest = GetHotSearchRequest;
exports.GetProductRequest = GetProductRequest;
exports.GetProductSpecsRequest = GetProductSpecsRequest;
var _request = _interopRequireDefault(__webpack_require__(/*! @/utils/request */ 47));
// 获取所有商品
function GetAllProductRequest() {
  var obj = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  return _request.default.get('/api/products', {
    params: obj
  });
}
// 获取单个商品
function GetProductRequest(productId) {
  return _request.default.get("/api/products/".concat(productId));
}
// 获取商品规格
function GetProductSpecsRequest(productId) {
  return _request.default.get("/api/products/".concat(productId, "/specs"));
}
// 获取热门搜索词
function GetHotSearchRequest() {
  var count = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
  return _request.default.get("/api/search/hot-keywords?limit=".concat(count));
}
...
exports.SendCodeRequest = SendCodeRequest;
var _request = _interopRequireDefault(__webpack_require__(/*! @/utils/request */ 47));
// 发送code获取openid和session_key
function SendCodeRequest(code, userInfo) {
  return _request.default.post('/api/wx/code2session', {
    code: code,
    userInfo: userInfo
  });
}
...
function GetUserInfoRequest() {
  return _request.default.get('/api/wx/user');
}
